...
const translations = {
  en: {
    ...
    materialsTitle: "Best private materials to sanitize and add next",
    materialsText: "One anonymized Jira defect, one Postman collection screenshot, one SQL/log investigation note, one regression checklist and one Confluence-style technical analysis. All with fake IDs, fake data and no client or production details.",
  ...
  pl: {
    ...
    materialsTitle: "Najlepsze prywatne materiały do anonimizacji",
    materialsText: "Jeden zanonimizowany defekt z Jira, screenshot kolekcji Postman, notatka z analizy SQL/logów, checklist regresji i krótka analiza techniczna w stylu Confluence. Wszystko na fikcyjnych ID i bez danych klientów ani produkcji.",
